...
import com.rubyfood.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.rubyfood.features.dashboard.presentation.ReasonDialog
...
import com.rubyfood.features.quotation.model.AddQuotInputModel
...
import com.rubyfood.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.rubyfood.features.viewAllOrder.api.addorder.AddOrderRepoProvider
...
import com.rubyfood.features.addshop.presentation.ShopExtraContactReq
...
import com.rubyfood.features.performance.model.Gps_status_list
import com.rubyfood.features.performance.model.UpdateGpsInputListParamsModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrubyfoodlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrubyfoodlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrubyfoodlogsample/log.zip").path);
