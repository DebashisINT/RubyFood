...
import com.rubyfood.app.NewFileUtils.browseDocuments
import com.rubyfood.app.NewFileUtils.browsePDFDocuments
import com.rubyfood.app.NewFileUtils.getExtension
import com.rubyfood.app.domain.*
import com.rubyfood.app.types.DashboardType
import com.rubyfood.app.types.FragType
import com.rubyfood.app.types.TopBarConfig
import com.rubyfood.app.uiaction.DisplayAlert
import com.rubyfood.app.utils.*
import com.rubyfood.app.utils.AppUtils.Companion.isProfile
...
import com.rubyfood.features.NewQuotation.*
import com.rubyfood.features.NewQuotation.api.GetQuotRegProvider
import com.rubyfood.features.NewQuotation.model.ViewDetailsQuotResponse
import com.rubyfood.features.SearchLocation.SearchLocationFragment
import com.rubyfood.features.SearchLocation.locationInfoModel
import com.rubyfood.features.TA.ViewAllTAListFragment
import com.rubyfood.features.achievement.AchievementFragment
import com.rubyfood.features.activities.presentation.*
import com.rubyfood.features.addAttendence.*
...
import com.rubyfood.features.addAttendence.model.Leave_list_Response
import com.rubyfood.features.addorder.presentation.AddOrderFragment
...
import com.rubyfood.features.addshop.presentation.OTPVerificationDialog
import com.rubyfood.features.addshop.presentation.ScanImageFragment
import com.rubyfood.features.addshop.presentation.ShowCardDetailsDialog
import com.rubyfood.features.alarm.model.AlarmData
import com.rubyfood.features.alarm.presetation.AttendanceReportFragment
import com.rubyfood.features.alarm.presetation.PerformanceReportFragment
import com.rubyfood.features.alarm.presetation.VisitReportDetailsFragment
import com.rubyfood.features.alarm.presetation.VisitReportFragment
import com.rubyfood.features.attendance.AttendanceFragment
...
import com.rubyfood.features.averageshop.presentation.AverageShopFragment
import com.rubyfood.features.avgorder.presentation.AverageOrderFragment
import com.rubyfood.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.rubyfood.features.beatCustom.TeamBeatListFragment
import com.rubyfood.features.billing.presentation.AddBillingFragment
import com.rubyfood.features.billing.presentation.BillingDetailsFragment
import com.rubyfood.features.billing.presentation.BillingListFragment
import com.rubyfood.features.changepassword.presentation.ChangePasswordDialog
import com.rubyfood.features.chat.model.ChatListDataModel
import com.rubyfood.features.chat.model.ChatUserDataModel
import com.rubyfood.features.chat.model.GroupUserDataModel
import com.rubyfood.features.chat.presentation.*
import com.rubyfood.features.chatbot.presentation.ChatBotFragment
import com.rubyfood.features.chatbot.presentation.ChatBotShopListFragment
import com.rubyfood.features.chatbot.presentation.ReportsFragment
import com.rubyfood.features.chatbot.presentation.SelectLanguageDialog
...
import com.rubyfood.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.rubyfood.features.dailyPlan.prsentation.AllShopListFragment
import com.rubyfood.features.dailyPlan.prsentation.DailyPlanListFragment
import com.rubyfood.features.dailyPlan.prsentation.PlanDetailsFragment
import com.rubyfood.features.damageProduct.ShopDamageProductListFrag
import com.rubyfood.features.damageProduct.ShopDamageProductSubmitFrag
import com.rubyfood.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.rubyfood.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
...
import com.rubyfood.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.rubyfood.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.rubyfood.features.dashboard.presentation.model.ContentListResponseModel
import com.rubyfood.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.rubyfood.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.rubyfood.features.device_info.presentation.DeviceInfoListFragment
import com.rubyfood.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.rubyfood.features.document.DocumentRepoFeatureNewFragment
import com.rubyfood.features.document.presentation.DocumentListFragment
import com.rubyfood.features.document.presentation.DocumentTypeListFragment
import com.rubyfood.features.document.presentation.OpenFileWebViewFragment
import com.rubyfood.features.dymanicSection.presentation.AddDynamicFragment
import com.rubyfood.features.dymanicSection.presentation.AllDynamicListFragment
import com.rubyfood.features.dymanicSection.presentation.DynamicListFragment
import com.rubyfood.features.dymanicSection.presentation.EditDynamicFragment
import com.rubyfood.features.gpsDisabilityScreen.GpsDisableFragment
import com.rubyfood.features.home.presentation.HomeFragment
import com.rubyfood.features.homelocation.presentation.HomeLocationFragment
import com.rubyfood.features.homelocation.presentation.HomeLocationMapFragment
import com.rubyfood.features.know_your_state.KnowYourStateFragment
import com.rubyfood.features.lead.LeadFrag
import com.rubyfood.features.lead.ViewLeadFrag
import com.rubyfood.features.leaveapplynew.LeaveHome
import com.rubyfood.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.rubyfood.features.localshops.LocalShopListFragment
import com.rubyfood.features.localshops.LocalShopListMapFragment
import com.rubyfood.features.localshops.NearByShopsMapFragment
import com.rubyfood.features.location.*
import com.rubyfood.features.location.api.LocationRepoProvider
import com.rubyfood.features.location.model.*
import com.rubyfood.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.rubyfood.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.rubyfood.features.login.ShopFeedbackEntity
import com.rubyfood.features.login.model.alarmconfigmodel.AlarmConfigDataModel
...
import com.rubyfood.features.logoutsync.presentation.LogoutSyncFragment
import com.rubyfood.features.marketAssist.MarketAssistTabFrag
import com.rubyfood.features.marketAssist.ShopDtlsMarketAssistFrag
import com.rubyfood.features.marketAssist.ShopListMarketAssistFrag
import com.rubyfood.features.marketing.presentation.MarketingPagerFragment
import com.rubyfood.features.meetinglist.prsentation.MeetingListFragment
import com.rubyfood.features.member.MapViewForTeamFrag
import com.rubyfood.features.member.model.TeamLocDataModel
import com.rubyfood.features.member.model.TeamShopListDataModel
import com.rubyfood.features.member.presentation.*
import com.rubyfood.features.menuBeat.MenuBeatFrag
import com.rubyfood.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.rubyfood.features.micro_learning.presentation.MicroLearningListFragment
import com.rubyfood.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.rubyfood.features.myallowancerequest.MyallowanceRequestFragment
import com.rubyfood.features.myjobs.model.CustomerDataModel
import com.rubyfood.features.myjobs.presentation.*
import com.rubyfood.features.myorder.presentation.MyOrderListFragment
import com.rubyfood.features.myprofile.presentation.MyProfileFragment
import com.rubyfood.features.nearbyshops.api.ShopListRepositoryProvider
import com.rubyfood.features.nearbyshops.model.ShopData
import com.rubyfood.features.nearbyshops.model.ShopListResponse
import com.rubyfood.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.rubyfood.features.nearbyshops.presentation.BeatListFragment
import com.rubyfood.features.nearbyshops.presentation.NearByShopsListFragment
import com.rubyfood.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.rubyfood.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.rubyfood.features.newcollection.CollectionDetailsStatusFragment
import com.rubyfood.features.newcollection.CollectionShopListFragment
import com.rubyfood.features.newcollection.NewCollectionListFragment
import com.rubyfood.features.newcollectionreport.*
import com.rubyfood.features.notification.NotificationFragment
import com.rubyfood.features.orderList.NewDateWiseOrderListFragment
import com.rubyfood.features.orderList.NewOrderListFragment
import com.rubyfood.features.orderList.OrderListFragment
import com.rubyfood.features.orderdetail.presentation.OrderDetailFragment
import com.rubyfood.features.orderhistory.ActivityMapFragment
import com.rubyfood.features.orderhistory.OrderhistoryFragment
import com.rubyfood.features.orderhistory.TimeLineFragment
import com.rubyfood.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.rubyfood.features.orderhistory.model.FetchLocationRequest
import com.rubyfood.features.orderhistory.model.FetchLocationResponse
import com.rubyfood.features.orderhistory.model.LocationData
import com.rubyfood.features.pendinglocationinout.PendingOutLocationFrag
import com.rubyfood.features.performance.GpsStatusFragment
import com.rubyfood.features.performance.PerformanceFragment
...
import com.rubyfood.features.performanceAPP.OwnPerformanceFragment
import com.rubyfood.features.performanceAPP.PerformanceAppFragment
import com.rubyfood.features.performanceAPP.allPerformanceFrag
import com.rubyfood.features.permissionList.ViewPermissionFragment
import com.rubyfood.features.photoReg.*
import com.rubyfood.features.privacypolicy.PrivacypolicyWebviewFrag
import com.rubyfood.features.quotation.presentation.*
import com.rubyfood.features.reimbursement.presentation.*
import com.rubyfood.features.report.presentation.*
import com.rubyfood.features.returnsOrder.*
import com.rubyfood.features.settings.presentation.SettingsFragment
import com.rubyfood.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.rubyfood.features.shopdetail.presentation.*
import com.rubyfood.features.shopdetail.presentation.api.EditShopRepoProvider
import com.rubyfood.features.stock.StockDetailsFragment
import com.rubyfood.features.stock.StockListFragment
import com.rubyfood.features.stockAddCurrentStock.AddShopStockFragment
import com.rubyfood.features.stockAddCurrentStock.UpdateShopStockFragment
import com.rubyfood.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.rubyfood.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.rubyfood.features.stockCompetetorStock.AddCompetetorStockFragment
import com.rubyfood.features.stockCompetetorStock.CompetetorStockFragment
import com.rubyfood.features.stockCompetetorStock.ViewComStockProductDetails
import com.rubyfood.features.survey.SurveyFrag
import com.rubyfood.features.survey.SurveyViewDtlsFrag
import com.rubyfood.features.survey.SurveyViewFrag
import com.rubyfood.features.task.presentation.AddTaskFragment
import com.rubyfood.features.task.presentation.CalenderTaskFragment
import com.rubyfood.features.task.presentation.EditTaskFragment
import com.rubyfood.features.task.presentation.TaskListFragment
import com.rubyfood.features.taskManagement.TaskManagementFrag
import com.rubyfood.features.taskManagement.ViewTaskManagementFrag
import com.rubyfood.features.timesheet.presentation.AddTimeSheetFragment
import com.rubyfood.features.timesheet.presentation.EditTimeSheetFragment
import com.rubyfood.features.timesheet.presentation.TimeSheetListFragment
import com.rubyfood.features.viewAllOrder.CartFragment
import com.rubyfood.features.viewAllOrder.OrderTypeListFragment
import com.rubyfood.features.viewAllOrder.ViewAllOrderListFragment
import com.rubyfood.features.viewAllOrder.ViewCartFragment
import com.rubyfood.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.rubyfood.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.rubyfood.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.rubyfood.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.rubyfood.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.rubyfood.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.rubyfood.features.viewPPDDStock.ViewOutstandingFragment
import com.rubyfood.features.viewPPDDStock.ViewPPDDListFragment
import com.rubyfood.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.rubyfood.features.viewPPDDStock.ViewStockFragment
import com.rubyfood.features.weather.presentation.WeatherFragment
import com.rubyfood.mappackage.MapActivity
import com.rubyfood.mappackage.MapActivityWithoutPath
...
//            Log.w(TAG, errorMessage);
    ...
    override fun loadFragment(mFragType: FragType, addToStack: Boolean, initializeObject: Any) {
        ...
        println("load_frag " + mFragType.toString() + "     " + Pref.user_id.toString()+" "+Pref.isRevisitCaptureImage )
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            ...
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrubyfoodlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.rubyfood/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrubyfoodlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrubyfoodlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrubyfoodlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrubyfoodlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
